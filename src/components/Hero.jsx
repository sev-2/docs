...
const code = `raiden init
raiden sync
raiden start`

const tabs = [
  { name: 'Raiden CLI', isActive: true },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Raiden help you and your team to build better app on top of Supabase.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Get started</Button>
                <Button href="https://github.com/sev-2/raiden" variant="secondary" target="_blank">
                  View on GitHub
                </Button>
              </div>
            </div>
